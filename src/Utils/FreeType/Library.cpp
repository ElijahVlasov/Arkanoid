...
FT_Face* Library::loadFace(const char* filePath, unsigned int index, FT_Face* faceBuf) {

	ASSERT(
		((filePath != 0) && (strlen(filePath) != 0)),
...
FT_Face* Library::loadFace(const string& filePath, unsigned int index, FT_Face* faceBuf) {
